...
export default function Auth() {
  return (
    <div className="min-h-screen grid grid-cols-2">
      <div className="flex items-center overflow-hidden min-h-screen relative justify-center ">
        <div className="absolute bottom-0 translate-y-1/2 left-0 -translate-x-1/2 rounded-full -z-20 w-[800px] h-[800px] opacity-30 bg-gradient-to-tr blur-3xl from-purple-500/60 to-primary/60" />
        <div className="w-full max-w-lg h-auto">
          <div className="flex justify-center mb-3">
            <Logo className="w-40" />
          </div>
          <h1 className="text-center text-4xl font-[600] tracking-tight mb-1">
            Welcome to Surplus!
          </h1>
          <Signup />
      ...
      <div className="flex items-center relative h-full min-h-screen justify-center overflow-hidden">
        <div className="absolute bottom-5 right-5 bg-white/50 backdrop-blur-2xl rounded-3xl p-5 shadow-xl border border-white/40 max-w-xs">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4 p-4 bg-white/20 backdrop-blur-xl rounded-2xl border border-slate-200/30 shadow-sm transition-transform hover:scale-[1.02]">
              <div className="bg-primary/80 p-3 rounded-full flex items-center justify-center shadow-md">
